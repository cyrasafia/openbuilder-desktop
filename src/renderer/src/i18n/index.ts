...
const zh = {
  ...
  findNext: "下一个",
  findClose: "关闭",
  scPageSearch: "在页面内查找（markdown 预览/浏览器/PDF）",
  scFindNext: "查找条内下一个/上一个",
  // 设置
  settings: "设置",
  ...
  modelsHint: "关闭的模型不出现在模型选择列表；已是当前会话模型的仍可正常使用。",
  ...
  // 快捷键列表页签（design-keyboard-shortcuts §8；newTab 复用 Tab 节既有键）
  shortcutsTitle: "快捷键",
  scGroupGlobal: "全局",
  scGroupInput: "输入与视图",
  scCloseTab: "关闭当前 Tab",
  ...
  scCycleScope: "按住修饰键用 ↑/↓ 选择项目/工作区，松开后切换作用域",
  scToggleLeft: "收起/展开左栏",
  scToggleRight: "收起/展开右栏",
  scSend: "发送消息；确认弹窗内 = 确认",
  scNewline: "输入框换行",
  scFileSearch: "文件内搜索",
  scFoldCode: "折叠/展开代码（代码视图全文级）",
  scTermCopy: "终端复制",
  scTermPaste: "终端粘贴",
...
const en: typeof zh = {
  ...
  findNext: "Next",
  findClose: "Close",
  scPageSearch: "Find in page (markdown preview / browser / PDF)",
  scFindNext: "Next/previous in find bar",
  settings: "Settings",
  ...
  modelsTitle: "Models",
  modelsSearch: "Search models (name/id/provider)…",
  modelsNoProject: "Open a project to manage models here (list is scope-aware)",
  modelsHint: "Disabled models disappear from model pickers; sessions already on them keep working.",
  modelsOffCount: " {off} off / {total} total",
  ...
  scGroupGlobal: "Global",
  scGroupInput: "Input & views",
  scCloseTab: "Close current tab",
  scRestoreTab: "Restore last closed tab",
  scNextTab: "Next tab",
  scPrevTab: "Previous tab",
  scOpenProject: "Open project picker",
  scCycleScope: "Hold the modifier and move with ↑/↓ to pick a project/worktree; release to switch scope",
  scToggleLeft: "Toggle left panel",
  scToggleRight: "Toggle right panel",
  scSend: "Send message; confirm in confirm dialogs",
  scNewline: "Newline in composer",
  scFileSearch: "Find in file",
  scFoldCode: "Fold/unfold code (document-wide, in code view)",
