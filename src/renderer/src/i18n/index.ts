...
const zh = {
  ...
  profileMode: "模式",
  // 模式段短标签（原 select 长标签废弃；说明一句话见 modeAttachDesc/modeManagedDesc）
  modeAttach: "连接现有服务",
  modeManaged: "本机启动",
  modeAttachDesc: "连接一个已在运行的 opencode server，填地址即可。",
  modeManagedDesc: "用本机的 opencode 自动启动一个 server，随机端口无需配置。",
  addProfile: "添加",
...
const en: typeof zh = {
  ...
  profileMode: "Mode",
  // Short labels for the mode segment (long select labels dropped; one-line
  // descriptions live in modeAttachDesc/modeManagedDesc)
  modeAttach: "Connect to existing",
  modeManaged: "Start locally",
  modeAttachDesc: "Connect to an opencode server that is already running.",
  modeManagedDesc: "Start a server with the local opencode binary; random port, zero config.",
  addProfile: "Add",
